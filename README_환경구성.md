...
// OTP 발급 확인
$ vault write ssh/creds/v-root-linux-acc-szzfc3DJI0gF4av ip=172.31.46.39
Key                Value
---                -----
lease_id           ssh/creds/v-root-linux-acc-szzfc3DJI0gF4av/nhXyPzFNnMMOCDQw7SA3beRR
lease_duration     768h
lease_renewable    false
ip                 172.31.46.39
key                3717e4f8-e560-c8e7-ff8c-f6799f1d0cd4
key_type           otp
port               22
username           v-root-linux-acc-szzfc3DJI0gF4av

// SSH 접속 확인
$ ssh ubuntu@172.31.46.39
 password: 3717e4f8-e560-c8e7-ff8c-f6799f1d0cd4
```
